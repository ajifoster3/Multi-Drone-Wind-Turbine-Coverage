...
class PegasusApp:
    ...
    def __init__(self):
        ...
        self.pg.load_environment("omniverse://localhost/Users/ajifoster3/Assets/WindFarmWithTurbines.usd")
    ...
    def vehicle_factory(self, vehicle_id: int, gap_x_axis: float):
        ...
        mavlink_config = MavlinkBackendConfig({
            ...
            "px4_autolaunch": True, 
            "px4_dir": "/home/ajifoster3/Applications/PX4-Autopilot", 
        ...
        Multirotor(
            ...
            ROBOTS['Iris'],
            vehicle_id,
            [-0.5 + gap_x_axis * vehicle_id, 0, 0.6],
