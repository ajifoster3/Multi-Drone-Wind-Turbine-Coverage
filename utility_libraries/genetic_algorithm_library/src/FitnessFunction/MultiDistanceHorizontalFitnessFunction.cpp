#include "MultiDistanceHorizontalFitnessFunction.h"

void MultiDistanceHorizontalFitnessFunction::calculateCostMap(std::vector<Position> &cities, std::vector<Position> &initialPositions)
{
...
const std::vector<double> MultiDistanceHorizontalFitnessFunction::getInversePathLengths(
...
double MultiDistanceHorizontalFitnessFunction::getInversePathLength(
    std::vector<int> &path,
    int agentID,
    std::vector<Position> &cities)
{
...
double MultiDistanceHorizontalFitnessFunction::calulateChromosomeFitness(
...
std::vector<std::vector<int>> MultiDistanceHorizontalFitnessFunction::getPaths(Chromosome &chromosome)
{
    std::vector<std::vector<int>> paths;
